package com.interview.others.date;
...
public class DateExamples {
  public static void main(String[] args) throws ParseException {
    ...
    System.out.println(DateFormat.getDateInstance(DateFormat.FULL, new Locale("it", "IT")).format(
        date));// marted� 16 ottobre 2012

    System.out.println(DateFormat.getDateInstance(DateFormat.FULL, Locale.ITALIAN).format(date));// marted�
                                                                                                 // 16
                                                                                                 // ottobre
                                                                                                 // 2012

    // This uses default locale US
    System.out.println(DateFormat.getDateInstance(DateFormat.FULL).format(date));// Tuesday, October
                                                                                 // 16, 2012

    System.out.println(DateFormat.getDateInstance().format(date));// Oct 16,
    // 2012
    System.out.println(DateFormat.getDateInstance(DateFormat.SHORT).format(date));// 10/16/12
    System.out.println(DateFormat.getDateInstance(DateFormat.MEDIUM).format(date));// Oct 16, 2012
    ...
    Date date2 = DateFormat.getDateInstance(DateFormat.SHORT).parse("10/16/12");
