package com.javaindepth.multithreading;
...
import com.javaindepth.multithreading.indexer.HttpConnect;
...
public class ExplicitLocksWithInterruption {
  ...
  private static class Downloader implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        InputStream in =
            new ByteArrayInputStream(weblink.getUrl().getBytes(StandardCharsets.UTF_8));
  ...
  public static void main(String[] args) {
    ExplicitLocksWithInterruption explicitLocksWithInterruption =
        new ExplicitLocksWithInterruption();
    explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2000,
        "Taming Tiger, Part 2",
        "http://www.javaworld.com/article/2072759/core-java/taming-tiger--part-2.html",
        "http://www.javaworld.com"));
    explicitLocksWithInterruption
        .add(explicitLocksWithInterruption
            .createWeblink(
                2001,
    ...
    explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2002,
