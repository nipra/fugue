...
public class ReflectionDemo {
  ...
  public static void demoCoreReflection(Class clazz) throws InstantiationException,
    ...
    for (Constructor c : clazz.getDeclaredConstructors()) {
      System.out.println("Constructor: " + c.getName() + ", # parameters: "
    ...
    Constructor<User> userConstructor =
        clazz.getDeclaredConstructor(int.class, String.class, String.class, String.class,
            String.class);
    @SuppressWarnings("unchecked")
